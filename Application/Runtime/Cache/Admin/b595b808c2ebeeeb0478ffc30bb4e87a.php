                ...
                <ul class="mList">
                    <li>
                        ...
                        <dl id="menu1" style="display:none;">
                                <dd><a href="/index.php/Admin/Pro/add" target="mainFrame">添加商品</a></dd>
                            <dd><a href="/index.php/Admin/Pro/list" target="mainFrame">商品列表</a></dd>
                        </dl>
                    </li>
                    <li>
                        <h3><span onclick="show('menu2','change2')" id="change2">+</span>分类管理</h3>
                        <dl id="menu2" style="display:none;">
                                <dd><a href="/index.php/Admin/Cate/add" target="mainFrame">添加分类</a></dd>
                            <dd><a href="/index.php/Admin/Cate/list" target="mainFrame">分类列表</a></dd>
                        </dl>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <dl id="menu4" style="display:none;">
                                <dd><a href="/index.php/Admin/User/add" target="mainFrame">添加用户</a></dd>
                            <dd><a href="/index.php/Admin/User/list" target="mainFrame">用户列表</a></dd>
                        </dl>
                    </li>
                    <li>
                        <h3><span onclick="show('menu5','change5')" id="change5">+</span>管理员管理</h3>
                        <dl id="menu5" style="display:none;">
                                <dd><a href="/index.php/Admin/Admin/add" target="mainFrame">添加管理员</a></dd>
                            <dd><a href="/index.php/Admin/Admin/list" target="mainFrame">管理员列表</a></dd>
                        </dl>
                    </li>
                        ...
                        <dl id="menu6" style="display:none;">
                            <dd><a href="/index.php/Admin/Image/list" target="mainFrame">商品图片列表</a></dd>
                        </dl>
                    </li>
                </ul>
            </div>
