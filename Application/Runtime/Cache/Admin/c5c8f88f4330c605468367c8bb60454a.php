...
<body>
<h3>编辑用户</h3>
<form action="/index.php/Admin/User/editHandle/id/<?php echo ($list["id"]); ?>" method="post" enctype="multipart/form-data">
<table width="70%" border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	<tr>
		<td align="right">用户名</td>
		<td><input type="text" name="username" placeholder="<?php echo ($list["username"]); ?>"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="email" placeholder="<?php echo ($list["email"]); ?>"/></td>
