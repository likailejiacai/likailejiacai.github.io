...
<div class="headerBar">
    ...
    <div class="userPosition comWidth">
        ...
        <span>&nbsp;&gt;&nbsp;</span>
        <a href="#"><?php echo ($data[$id]['cname']); ?></a>
        <span>&nbsp;&gt;&nbsp;</span>
        <em><?php echo ($data[$id]['psn']); ?></em>
    </div>
        ...
        <div class="description clearfix">
            <div class="leftArea">
                <div class="description_imgs">
                    <div class="big">
                        <a href="/Public/Uploads/image_800/<?php echo ($album[0]['albumpath']); ?>" class="jqzoom" rel='gal1'  title="triumph" >
                            <img width="309" height="340" src="/Public/Uploads/image_350/<?php echo ($album[0]['albumpath']); ?>"  title="triumph">
                        </a>
                    </div>
                    <ul class="des_smimg clearfix" id="thumblist" >
                        <?php if(is_array($album)): foreach($album as $key=>$img): ?><li><a class="zoomThumbActive active" href='javascript:void(0);'><img src="/Public/Uploads/image_50/<?php echo ($img['albumpath']); ?>" rel="{gallery: 'gal1', smallimage: '/Public/Uploads/image_350/<?php echo ($img['albumpath']); ?>',largeimage: '/Public/Uploads/image_8006/<?php echo ($img['albumpath']); ?>}"alt=""></a></li><?php endforeach; endif; ?>
                    </ul>
                </div>
            </div>
            <div class="rightArea">
                <div class="des_content">
                    <h3 class="des_content_tit"><?php echo ($data[$id]['pname']); ?></h3>
                    <div class="dl clearfix">
                        <div class="dt">慕课价</div>
                        <div class="dd clearfix"><span class="des_money"><em>￥</em><?php echo ($data[$id]['iprice']); ?></span></div>
                    </div>
                    <div class="dl clearfix">
                        <div class="dt">优惠</div>
    ...
    <div class="des_info comWidth clearfix">
        <div class="leftArea">
            <div class="recommend">
                ...
                <div class="item">
                    <div class="item_cont">
                        <div class="img_item">
                            <a href="#"><img src="/Application/Home/Public/images/shopImg.jpg" alt=""></a>
                        </div>
        ...
        <div class="rightArea">
            <div class="des_infoContent">
                ...
                <div class="ad">
                    <a href="#"><img src="/Application/Home/Public/images/ad.jpg"></a>
                </div>
                <div class="info_text">
                    <div class="info_tit">
                    ...
                    <p>现在就是买mini的好时候！换代清仓直降，但苹果品质不变！A5双核，内置Lightning闪电接口，正反可插，方便人性。小身材，炫丽的7.9英寸显示屏，7.2mm的厚度，薄如铅笔。女生包包随身携带更时尚！facetime视频通话，与密友24小时畅聊不断线。微信倾力打造，你的智能助理。苹果的牌子就不用我说了，1111补仓，存货不多哦！</p>
                    <div class="hr_45"></div>
                    <img src="/Application/Home/Public/images/pad.jpg" class="center">
                    <div class="hr_45"></div>
                </div>
            </div>
            <div class="hr_15"></div>
                    ...
                    <div class="review_list clearfix">
                        <div class="review_userHead fl">
                            <div class="review_user">
                                <img src="/Application/Home/Public/images/userhead.jpg" alt="">
                                <p>61***42</p>
                                <p>金色会员</p>
                            </div>
                        </div>
    ...
    <div class="footer">
        ...
        <p class="web"><a href="#"><img src="/Application/Home/Public/images/webLogo.jpg" alt="logo"></a><a href="#"><img src="/Application/Home/Public/images/webLogo.jpg" alt="logo"></a><a href="#"><img src="images/webLogo.jpg" alt="logo"></a><a href="#"><img src="/Application/Home/Public/images/webLogo.jpg" alt="logo"></a></p>
    </div>
    </body>
