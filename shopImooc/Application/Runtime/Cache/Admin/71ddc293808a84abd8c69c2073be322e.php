...
<div class="content clearfix">
    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
        <?php if(is_array($cateInf)): foreach($cateInf as $key=>$cate): ?><tr>
                <td><?php echo ($cate["id"]); ?></td>
                <td><?php echo ($cate["cname"]); ?></td>

                <td><a class="btn btn-default" role="button" href="<?php echo U('Admin/editCate',array('id'=>$cate['id']));?>">编辑</a> <a class="btn btn-default" role="button" href="<?php echo U('Admin/deleteCate',array('id'=>$cate['id']));?>">删除</a></td>
