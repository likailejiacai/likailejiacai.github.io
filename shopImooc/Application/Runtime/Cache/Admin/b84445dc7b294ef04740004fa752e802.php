...
<?php if(is_array($userInf)): foreach($userInf as $key=>$user): ?><tr>
        ...
        <td><?php echo ($user["activeflag"]); ?></td>
        <td><a class="btn btn-default" role="button" href="<?php echo U('Admin/editUser',array('id'=>$user['id']));?>">编辑</a> <a class="btn btn-default" role="button" href="<?php echo U('Admin/deleteUser',array('id'=>$user['id']));?>">删除</a></td>
