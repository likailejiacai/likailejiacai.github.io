...
<div class="content clearfix">
    ...
    <form action="<?php echo U('Admin/editAdmin',array('id'=>$userInf['id']));?>" method="post">
        <div class="form-group">
            <label for="exampleInputEmail1">User Name</label>
            <input type="text" class="form-control" id="username" placeholder="<?php echo ($userInf["username"]); ?>" name="username">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" id="exampleInputEmail1" placeholder="<?php echo ($userInf["email"]); ?>" name="email">
        </div>
